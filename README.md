...
The Kaggle download also includes `clean_final_data.csv` as an external reference file. It is intentionally ignored by the project pipeline. The analytical dataset used by this project is `orders_analytical.csv`, generated by the data cleaning and transformation notebook `02_data_cleaning.ipynb`.
